    ...
    <div>
      ...
      <form action="edit/ubah_profil.php" method="post">
        <div class="form-group">
          ...
          <br>
          <label for="sel1">Mobil :</label>
          <input class="form-control" name="komentar" value="<?php echo $_SESSION['merk'] ?>" readonly>
          <br>
          <label for="sel1">Password :</label>
          <input class="form-control" value="<?php echo $_SESSION['password']?>" readonly>
        </div>
        <button class="btn btn-success btn-block" name="simpan_komentar">Ubah Profil</button>
      </form>
      <br>
     <ul class="nav menu">
