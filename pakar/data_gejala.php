...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
  ...
  <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
      ...
      <li class="active"><a href="data_gejala.php"><em class="fa fa-sticky-note-o">&nbsp;</em> Data Gejala</a></li>
  ...
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div>
        <br>
        <h3><b>Masukan data gejala jika ingin di tambahkan</b></h3>
        <form method="post" action="../proses/proses.php">
        <div class="form-group">
          <input class="form-control" type="text" name="gejala" placeholder="Masukan Data Gejala Baru">
        </div>
        <button class="btn btn-primary btn-block" name="simpan_gejala">Simpan</button>
        <br><br>
        <h3><b>Tabel Gejala</b></h3>
        ...
        <tbody>
          ...
          foreach ($gejala as $key => $value) {?>
            <tr>
              <td><?php echo $i; ?></td>
              <td><?php echo $value['kode_g']; ?></td>
              <td><?php echo $value['gejala']; ?></td>
              <td>
                <div class="btn-group">
                  <a  class="btn btn-success" href="edit/edit_gejala.php?no=<?php echo $value['kode_g'] ?>">Ubah</a>
                  <a class="btn btn-danger" href="../proses/proses.php?no=<?php echo $value['kode_g'] ?>&hapus_gejala">Hapus</a>
                </div>
              </td>
            </tr>
          <?php $i++;} ?>
