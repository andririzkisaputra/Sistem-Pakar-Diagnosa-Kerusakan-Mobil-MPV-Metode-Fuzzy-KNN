...
<div class="row">
    <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
      <div class="login-panel panel panel-default">
        <div class="panel-heading">Ubah Gejala</div>
        <div class="panel-body">
          <form action="../../proses/proses.php" method="post">
        <?php foreach ($tampil as $value) { ?>
          <div class="form-group">
          <label for="fname">Kode Gejala</label>
          <input class="form-control" type="text" name="kode_g" value="<?php echo $value['kode_g']; ?>" readonly>
          <br>
          <label for="fname">Gejala</label>
          <input class="form-control" type="text" name="gejala" placeholder="Masukan gejala . . ." value="<?php echo $value['gejala']; ?>">
        <?php } ?>
        <br>
        <button class="btn btn-success btn-block" name="edit_gejala">Ubah</button>
        </form>
        <br>
        <a href="../data_gejala.php"><span class="fa fa-arrow-left"></span> <b>BATAL</b></a>
        </div>
      </div>
    </div><!-- /.col-->
  </div><!-- /.row -->  
