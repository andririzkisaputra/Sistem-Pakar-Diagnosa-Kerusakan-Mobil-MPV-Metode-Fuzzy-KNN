...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
  ...
  <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
      <li class="active"><a href="data_kerusakan.php"><em class="fa fa-sticky-note">&nbsp;</em> Data Kerusakan</a></li>
  ...
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div>
        <br>
        <h3><b>Masukan data kerusakan jika ingin di tambahkan</b></h3>
        <form method="post" action="../proses/proses.php">
        <div class="form-group">
          <input class="form-control" type="text" name="kerusakan" placeholder="Masukan Data Kerusakan Baru">
        </div>
        <button class="btn btn-primary btn-block" name="simpan_kerusakan">Simpan</button>
        </form>
        <br><br>
        <h3><b>Tabel Kerusakan</b></h3>
        ...
        <tbody>
          ...
          foreach ($kerusakan as $key => $value) {?>
            <tr>
              <td><?php echo $i; ?></td>
              <td><?php echo $value['kode_k']; ?></td>
              <td><?php echo $value['kerusakan']; ?></td>
              <td>
                <div class="btn-group">
                  <a  class="btn btn-success" href="edit/edit_kerusakan.php?no=<?php echo $value['kode_k'] ?>">Ubah</a>
                  <a class="btn btn-danger" href="../proses/proses.php?no=<?php echo $value['kode_k'] ?>&hapus_kerusakan">Hapus</a>
                </div>
              </td>
            </tr>
          <?php $i++;} ?>
