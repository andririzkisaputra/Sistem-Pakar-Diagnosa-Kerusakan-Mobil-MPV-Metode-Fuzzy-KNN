...
$tampil_latih = $db->tampil_data_latih_id($kerusakan);
foreach ($tampil_latih as $key => $value) {
	$nilai[] = $value['nilai_data_latih'];
}
  ...
  <div class="row">
    <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
      <div class="login-panel panel panel-default">
        <div class="panel-heading">Ubah Data Latih</div>
        <div class="panel-body">
        <form action="../../proses/proses.php" method="post">
			<div class="form-group">
			<label>Kode Data Latih</label>
		...
		<label>⚪ Pilih Gejala</label>
          <table id="example" class="display nowrap" style="width:100%">
            ...
            <tbody>
              ...
              <tr>
                ...
                <?php if ($nilai[$i] == 1){ ?>
                <td><input type="checkbox" name="gejala[]" value="<?php echo $kode_gejala[$i] ?>" checked></td>
                <?php }else{ ?>
          ...
          <br>
          <button class="btn btn-success btn-block" name="edit_data_latih">Ubah</button>
          <br>
          </form>
          <br>
