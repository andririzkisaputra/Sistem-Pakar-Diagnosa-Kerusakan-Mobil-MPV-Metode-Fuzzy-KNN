...
$tampilan_komentar = $db->tampil_komentar();
?>
<!DOCTYPE html>
<html>
<head>
...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
  ...
  <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
      ...
      <li class="active"><a href="data_komentar.php"><em class="fa fa-sticky-note-o">&nbsp;</em> Data Komentar</a></li>
  ...
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div>
      <br>
        ...
        <tbody>
          <?php $i = 1;
          foreach ($tampilan_komentar as $key => $value) {?>
              <tr>
                <td><?php echo $i; ?></td>
                <td><?php echo $value['username']; ?></td>
                <td><?php echo $value['waktu']; ?></td>
                <td><?php echo $value['komentar']; ?></td>
                <td><a class="btn btn-danger" href="../proses/proses.php?no=<?php echo $value['no'] ?>&hapus_komentar">Hapus</a></td>
              </tr>
          <?php $i++;} ?>
        </tbody>
        <tfoot>
